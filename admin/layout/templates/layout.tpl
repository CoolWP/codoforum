...
<html>
    <head>
      ...
      <!--   <link href="{$A_RURI}css/bootstrap.min.css" rel="stylesheet" type="text/css" /> -->
        <link href="//cdn.bootcss.com/bootstrap/3.0.2/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- font Awesome -->
       ...
       <!--  <link href="{$A_RURI}css/ionicons.min.css" rel="stylesheet" type="text/css" /> -->
        <link href="//cdn.bootcss.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css" />
